...
<body class="bg-gray-200">
    ...
    <div class="container mx-auto">
        ...
        <div
            class="modal h-screen w-full z-50 fixed left-0 top-0 flex justify-center items-center bg-black bg-opacity-50 overflow-y-auto hidden">
            <div class="bg-white rounded shadow-lg w-1/2">
                ...
                <div class="p-3">
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <input type="text" id="name" name="nama_produk" placeholder="Masukkan Nama produk..."
                            class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:border-black mt-1 mb-2"
                            require>

                        <label class="mt-2 text-sm font-semibold" id="harga_produk">Harga Produk</label>
                        <input type="text" id="name" name="harga_produk" placeholder="Masukkan Harga produk..."
                            class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:border-black mt-1 mb-2"
                            require>
                        ...
                        <input type="text" id="name" name="stok_produk" placeholder="Masukkan Jumlah Stok produk..."
                            class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:border-black mt-1 mb-2"
                            require>
        ...
        <div class="flex flex-wrap ml-60 gap-5">
            ...
            if(isset($_GET['cari'])) {
                ...
                INNER JOIN jenis ON produk.id_jenis = jenis.id_jenis
                INNER JOIN kategori ON produk.id_kategori = kategori.id_kategori WHERE nama_produk LIKE '%".$_GET['cari']."%'");
            }
            while($data = mysqli_fetch_array($result)){
            ?>
            <div class="w-48 h-auto bg-white rounded-sm p-2">
                ...
                <div class="">
                    ...
                    <p class="font-sm text-gray-700 "><?php echo $data['nama_kategori'] ?></p>
