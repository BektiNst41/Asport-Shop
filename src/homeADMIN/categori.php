            ...
            <div class="bg-white rounded shadow overflow-x-auto">
                <table class="min-w-full border-separate">
                    <thead>
                        <tr>
                            <th
                                class="px-6 py-3 bg-gray-500 text-left text-xs leading-4 font-semibold text-white uppercase tracking-wider text-center">
                                No</th>
                            <th
                                class="px-6 py-3 bg-gray-500 text-left text-xs leading-4 font-semibold text-white uppercase tracking-wider text-center">
                                Nama</th>
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-100 transition-colors duration-300 text-center">
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap"><?php echo $row["nama_kategori"] ?></td>
